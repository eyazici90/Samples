...
namespace PayFlex.Identity.Domain.AggregatesModel.UserAggregate
{
    ...
    { 
        ...
        Task<IEnumerable<UserAssignedToRole>> GetUserRolesByUserId(int userId);
        ...
        IQueryable<UserAssignedToTenant> GetUserTenantsByUserName(string username);

        IQueryable<UserAssignedToPermission> GetUserPermissionsByUserId(int userId);

...
namespace PayFlex.Identity.Domain.Tests.AggregatesTests
{
    public class UserAggregateTests
    {
        ...
        {
            var newUser = User.Create(fakeUserName);
        ...
        public void Create_new_user_aggregateroot_fail()
        {
            ...
            Action act = () => User.Create(fakeName);
        ...
        public void Create_new_user_aggregateroot_success()
        {
            ...
            var createdNewUser = User.Create(fakeName);
        ...
        private User fakeUser => User.Create(fakeUserName);
